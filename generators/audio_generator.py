...
class AudioGenerator:
    def generate_audio(self, workdir: str, story_page_content: StoryPageContent) -> AudioInfo:
        ...
        mp3_filepath = os.path.join(workdir, f"audio_{story_page_content.page_number}.mp3")
